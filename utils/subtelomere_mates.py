...
# Open output file
output_file = pysam.AlignmentFile(args.output + ".bam","wb", template = bamfile)
...
print("telomere_mates.py: found " + str(counter) + " discordant subtelomere pairs.")

# Sort and index bam file
subprocess.call(["samtools", "sort", "-o", args.output + ".sorted.bam", args.output + ".bam"])
